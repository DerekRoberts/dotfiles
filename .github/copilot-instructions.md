...
- **ShellCheck Compliance:** All modified or newly authored Bash scripts must pass ShellCheck without warnings or silenced errors (`shellcheck -x setup.sh scripts/*.sh scripts/setup/*.sh`).
