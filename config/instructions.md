...
- **Rule & Skill Hygiene**: Condense only the rule or skill being edited for density and impact before saving. Strip filler, kill duplicate lists, point to single sources of truth. Maximum signal, zero bloat.
